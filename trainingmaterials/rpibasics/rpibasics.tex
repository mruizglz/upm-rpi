...
% ---------------- Slide 2 ----------------
\begin{frame}{What ``embedded'' can mean (spectrum)}
\begin{itemize}
...
\textbf{Use when:} UI, gateways, heavy networking, complex updates.
\end{frame}
...
% ---------------- Slide 9 ----------------
\begin{frame}{Alternative \#6: SoC/SiP direct-to-board (full custom)}
\textbf{What it is:} place the SoC + DDR + PMIC yourself
\vspace{0.6em}
...
% ---------------- Slide 13 (was 11) ----------------
\begin{frame}{Which MCU family? (practical buckets)}
\begin{itemize}
  \item \textbf{Connectivity-first IoT:} ESP32 class (Wi-Fi/BLE integrated)
  \item \textbf{Control/industrial ecosystem:} STM32 class
  \item \textbf{Low-cost general dev:} Arduino ecosystem
  \item \textbf{Dual-core MCU w/ good tooling:} RP2040 boards
\end{itemize}
\end{frame}
