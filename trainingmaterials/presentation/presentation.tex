...
\begin{frame}{Basic Information}
  \begin{itemize}
    ...
    \begin{itemize}
      ...
      \item Assistant: Alejandro Piñas (\href{mailto:a.pinas@alumnos.upm.es}{a.pinas@alumnos.upm.es})
    \end{itemize}
  \end{itemize}
\end{frame}
...
\begin{frame}{Main Objectives}
  \begin{itemize}
    ...
    \item Use Git for collaborative project development.
  \end{itemize}
\end{frame}
...
\begin{frame}{Course assessment}
    ...
    \begin{itemize}
        ...
        \item Project 3 presentation and verification. Logbook and code (github/gitlab/etc) assessment  (60\%). Repo contributions from the two members.
        \item Any block assessment requires a minimum of 40 out of 100.
    \end{itemize}
\end{frame}
